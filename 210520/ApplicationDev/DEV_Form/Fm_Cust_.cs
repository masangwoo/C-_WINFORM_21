    ...
    public partial class Fm_Cust_ : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Cmd.CommandText = "UPDATE TB_CUSTOMER_MSW                      " +
                             ...
                             " IF (@@ROWCOUNT =0)                     " +
                             " INSERT INTO TB_CUSTOMER_MSW (CUSTCODE,     CUSTTYPE,     CUSTNAME,     BIZCLASS,     BIZTYPE,     USEFLAG,     FIRSTDATE,   MAKEDATE,   MAKER) " +
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                #region Transaction Commit
                Cmd.CommandText = $"DELETE TB_CUST_MSW WHERE CUSTCODE = '{delCustCode}'";
                Cmd.ExecuteNonQuery();
                Txn.Commit();
                #endregion
